...
5. [Usage Notes for Non-Claude Agents](#usage-notes-for-non-claude-agents)
...
- Codex auto-loads `AGENTS.md` from project root - you're set
- Codex doesn't have native MCP support - use REST APIs for Canva/Vercel/etc
- Use the workflow skills as structured prompts when relevant
- Reference `tasks/todo.md` and `tasks/lessons.md` for state
