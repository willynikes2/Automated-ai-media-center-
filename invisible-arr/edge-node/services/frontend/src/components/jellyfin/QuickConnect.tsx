  ...
  return (
    <Card className="p-6 text-center">
      ...
      <p className="text-sm text-text-secondary mb-6 max-w-sm mx-auto">
        Generate a code to link Jellyfin apps on your TV, phone, or other devices.
      </p>
      ...
      {authenticated ? (
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-text-secondary">Enter this code in your Jellyfin app to connect.</p>
      ...
      <div className="mt-6 text-left">
        ...
        <ol className="text-sm text-text-secondary space-y-1 list-decimal list-inside">
          ...
          <li>Open your Jellyfin app on any device</li>
